...
var ConvertedValue;
var buttonConvertToGram = document.getElementById("buttonConvertToGram");
var buttonConvertToOunces = document.getElementById("buttonConvertToOunces");
function toGram(ounceValue) {
    return ounceValue * 28.34952;
}
function toOunces(gramValue) {
    return gramValue * 0.03527396195;
}
var element1 = document.getElementById("convertedValue");
buttonConvertToGram.addEventListener("click", function (MouseEvent) {
    ConvertedValue = toGram(value.valueAsNumber);
    element1.innerHTML = ConvertedValue + " gram";
});
buttonConvertToOunces.addEventListener("click", function (MouseEvent) {
